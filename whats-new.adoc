...
summary: Scopri le novità sul supporto di Google Cloud NetApp Volumes nella console NetApp . 
---
= Cosa c'è di nuovo
:hardbreaks:
:allow-uri-read: 
...
[role="lead"]
Scopri le novità sul supporto di Google Cloud NetApp Volumes nella console NetApp .
